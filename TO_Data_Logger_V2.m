function varargout = TO_Data_Logger_V2(varargin)
% TO_DATA_LOGGER MATLAB code for TO_Data_Logger_V2.fig
...
%         end
    ...
    if(get(handles.Plot_button,'Value')) %plot the vector
        if (i_first_plot_point == 1) %First time plot was requested, so need to cycle through
            x_0=current_x;
            y_0=current_y;
            i_first_plot_point=0;
        else
            x_0=current_x;
            y_0=current_y;
...
%         plot(handles.axes1,x_to_plot,y_to_plot)
        ...
        line(handles.axes1,[x_0 x_1], [y_0 y_1]);
        x_0=x_1;
        y_0=y_1;
...
%         else %TO output points
             fprintf(FID,'%6u %6u %6u %6.2f %6.2f %6u\n',[hour min sec current_Disp current_Load 0]);
